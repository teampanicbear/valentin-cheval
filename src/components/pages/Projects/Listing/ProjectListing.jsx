      ...
      },
      {
        y:
          window.innerWidth > 767
            ...
            : document.querySelector(`.projects__position-name`).offsetTop -
              transitionDOM('name').offsetTop,
        scale: window.innerWidth <= 767 ? 1.1428571429 : window.innerWidth <= 991 ? 1.4375 : 2,
      }
    )
      .fromTo(
