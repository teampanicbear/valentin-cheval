...
const SocialShare = (props) => {
    ...
    return (
        <div class="post__content-share-inner">
            <a href="#" data-share="linkedin" class="post__content-share-item">
            ...
            <a href="#" data-share="facebook" class="post__content-share-item">
                <div class="post__content-share-item-ic">
                    <div class="ic ic-24">
                        {props.facebook}
                    </div>
            ...
            <a href="#" data-share="twitter" class="post__content-share-item">
                <div class="post__content-share-item-ic">
                    <div class="ic ic-20">
                        {props.twitter}
                    </div>
            ...
            <a href="#" data-share="copy" class="post__content-share-item">
                <div class="post__content-share-item-ic">
                    <div class="ic ic-20">
                        {props.copy}
                    </div>
