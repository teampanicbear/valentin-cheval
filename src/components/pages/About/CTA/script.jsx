...
const CTAScript = () => {
    ...
    onMount(() => {
        ...
        autoAlpha: 1, yPercent: 0, duration: 1.2, stagger: .1 ,ease: 'power2.out',
            onComplete: () => { 
        ...
        gsap.to([...textContentCTA.words,'.about__cta-head-content-txt-inner' ], {
            yPercent: 0, autoAlpha: 1, duration: 1.2, ease: 'power2.out', stagger: .15, 
            // delay: (index ) => {
            //     return 0.2 * index
            // }  ,
        ...
        gsap.to('.about__cta-head-content-txt-inner', {
            ...
            ...ScrollOption('.about__cta-head-content-txt'),
            onComplete: () => {
                document.querySelectorAll('.about__cta-head-content-txt-inner .slide-txt-wrap').forEach((item, index) => { 
                    setTimeout(() => {
                        item.click()
                    }, index * 400)
                })
    ...
    gsap.to(textCTABody.words, {
        ...
        listContactItem.forEach(contact => { 
            ...
            gsap.to([ ...labelSpliting.words, ...listSocials.words ], {
                autoAlpha: 1, yPercent: 0, duration: 1.2, stagger: .15, ease: 'power2.out',
                onComplete: () => {
