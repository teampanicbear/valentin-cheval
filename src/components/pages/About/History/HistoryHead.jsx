    ...
    onMount(() => {
        ...
        gsap.to([textHistory.words,'.about__history-title-inner'], {
            ...
            onComplete: () => {
                ...
                document.querySelectorAll('.about__history-title-txt').forEach(el => el.removeAttribute('style'));   
                document.querySelectorAll('.about__history-title-sb').forEach(el => el.removeAttribute('style'));
            }, 
    ...
    return (
        <>
            <h2 ref={scriptRef} class="upper fix-font about__history-title grid">
                <div class="heading h2 fw-bold about__history-title-txt"><span>I have</span></div>
                <div class="heading h2 fw-bold cl-txt-orange about__history-title-txt"> 
                    <span>{Number(props.currentYear) - 16} years</span></div>
                <div class="heading h2 fw-bold about__history-title-txt"><span>of Experience</span></div>
                <div class="heading h2 fw-bold about__history-title-txt inline-flex">
                    <span>in
                    </span> 
                    <div>&nbsp;</div>
                 <div class="cl-txt-title inline-block
                ...
                <div class="heading h2 fw-bold about__history-title-txt"><span>field</span> </div>
            </h2>
            <h2 class="upper fix-font about__history-title mod-mb grid">
                <div class="heading h2 fw-bold about__history-title-txt"><span>I have</span></div>
                <div class="heading h2 fw-bold about__history-title-txt">
                    <span class='inline-flex'><span class="cl-txt-orange">8 years</span><span>&nbsp;</span>of</span></div><div class="heading h2 fw-bold about__history-title-txt"><span>Experience</span></div>
                <div class="heading h2 fw-bold about__history-title-txt inline-flex"><span>in</span>
                    <div>&nbsp;</div>
                    <div class="cl-txt-title inline-block 
                    about__history-title-sb
                ">
